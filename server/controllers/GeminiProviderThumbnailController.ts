...
const generateImageWithGeminiProvider = async (prompt: string, aspectRatio: string = '16:9') => {
  try {
...
const generateImageWithDirectGemini = async (prompt: string, aspectRatio: string = '16:9') => {
  try {
...
export const generateThumbnailWithGeminiProvider = async (req: Request, res: Response) => {
