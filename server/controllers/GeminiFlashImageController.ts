...
const generateImageWithGeminiFlash = async (prompt: string, aspectRatio: string = '16:9') => {
  try {
...
export const generateThumbnailWithGeminiFlash = async (req: Request, res: Response) => {
