...
const generateImageWithProvider = async (prompt: string, aspectRatio: string = '16:9') => {
  try {
...
export const generateThumbnailWithUniversalProvider = async (req: Request, res: Response) => {
