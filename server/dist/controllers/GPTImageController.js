...
const generateImageWithGPTImage = async (prompt, aspectRatio = '16:9') => {
    try {
...
export const generateThumbnailWithGPTImage = async (req, res) => {
    let thumbnail = null;
    try {
        ...
        let prompt = `Professional YouTube thumbnail masterpiece: ${stylePrompts[style]} for "${title}".`;
        if (color_scheme) {
