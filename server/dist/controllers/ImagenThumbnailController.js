...
const generateImageWithImagen = async (prompt, aspectRatio = '16:9') => {
    try {
...
const generateImageWithVertexAI = async (prompt, aspectRatio = '16:9') => {
    try {
        ...
        const response = await axios.post('https://us-central1-aiplatform.googleapis.com/v1/projects/YOUR_PROJECT/locations/us-central1/publishers/google/models/imagen-3.5:predict', requestBody, {
            headers: {
                'Authorization': `Bearer ${process.env.image_api_key}`,
                'Content-Type': 'application/json'
            },
...
export const generateThumbnailWithImagen = async (req, res) => {
    let thumbnail = null;
    try {
