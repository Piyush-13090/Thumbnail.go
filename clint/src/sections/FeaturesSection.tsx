...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why choose us" text3="Create stunning thumbnails which get clicks, without any hustle." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Our AI understand your content and generate the best thumbnail for you.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Boost your click rate</h3>
                        <p className="text-slate-300 mt-2">Stop guessing and start converting with our AI-powered thumbnail generator.</p>
